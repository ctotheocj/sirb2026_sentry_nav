...
def generate_launch_description():
    bringup_dir = get_package_share_directory("sirb2026_nav_bringup")
    ...
    load_composable_nodes = LoadComposableNodes(
        ...
        composable_node_descriptions=[
            # GridMapComponent must load before SmootherServer so the registry is populated
            ComposableNode(
                package="plan_env",
            ...
            ComposableNode(
                package="hole_pass_controller",
                plugin="hole_pass_controller::NavigationModeManagerNode",
                name="navigation_mode_manager",
                parameters=[configured_params],
            ),
            ComposableNode(
    ...
    load_sensor_scan_generation_composable = LoadComposableNodes(
        ...
        composable_node_descriptions=[
            ComposableNode(
                ...
                name="loam_interface",
                parameters=[configured_params],
                # loam_interface uses absolute /tf internally; must remap so it
                # publishes to the namespaced tf topic used by all nav2 nodes.
                remappings=[("/tf", "tf"), ("/tf_static", "tf_static")],
            ),
            ComposableNode(
                package="sensor_scan_generation",
